...
<template>
  <el-container id="container">
    <el-header>
      <span
        style="float: left;font-size: 24px;font-family:'Courier New', Courier, monospace;font-weight: bold;"
      >
    ...
    <el-container>
      ...
      <el-aside>
        ...
        >
          ...
          <el-menu-item index="1" @click="navigateTo('/')" class="className">
          ...
          <el-menu-item
            v-show="user.deptName == '财务部'"
            index="8"
            @click="navigateTo('/finana')"
            class="className"
          >
...
.className:hover {
  ...
  filter: hue-rotate(10deg) brightness(120%) saturate(100%) !important;
  background: #2851e3 !important;
}
#container {
  height: inherit;
}
