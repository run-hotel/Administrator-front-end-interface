...
<script>
  import {batchDeleteBook, getAllOrderType, delOrderType, addOrderType, getOrderTypeById, updateOrderType } from '../../api/orderType'
  ...
  export default {
    ...
    methods: {
      ...
      fetchData() {
        ...
        getAllOrderType(this.currentPage,this.pageSize,this.search).then(res => {
          console.log(res)
